...
const Popup = ({ taskRecord, onClose }) => {
    ...
    const [valleysData, setValleysData] = useState(taskRecord.linePlot.Valleys.data);
    const [valleysTimes, setValleysTimes] = useState(taskRecord.linePlot.Valleys.time);
